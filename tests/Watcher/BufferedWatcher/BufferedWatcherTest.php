...
{
    public function testBufferedWatcher(): void
    {
    ...
    public function testDeduplicatesFiles(): void
    {
        $expectedFile1 = new ModifiedFile('/foo', ModifiedFile::TYPE_FILE);
    ...
    public function testReturnsNulLWhenInnerWatcherStops(): void
    {
        $expectedFile1 = new ModifiedFile('/foo', ModifiedFile::TYPE_FILE);
        $queue = new ModifiedFileQueue([
            $expectedFile1,
    ...
    public function testErrorsBubbleUp(): void
    {
